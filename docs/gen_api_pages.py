...
GROUPS = {
    "组件 Widgets": [
        ...
        ("checkbox", "FluCheckBox 复选框"),
        ("radiobox", "FluRadioBox 单选框"),
        ("entry", "FluEntry 单行输入"),
        ("text", "FluText 多行文本"),
        ("label", "FluLabel 标签"),
        ("frame", "FluFrame 面板"),
    ...
    "设计规范 Designs": [
        ...
        ("designs.button", "按钮配色"),
        ("designs.badge", "徽标配色"),
        ("designs.checkbox", "复选框配色"),
        ("designs.radiobox", "单选框配色"),
        ("designs.listbox", "列表配色"),
        ("designs.litenav", "导航栏配色"),
        ("designs.control", "通用控件配色"),
        ("designs.entry", "输入框配色"),
        ("designs.text", "文本框配色"),
        ("designs.frame", "面板配色"),
        ("designs.label", "标签配色"),
